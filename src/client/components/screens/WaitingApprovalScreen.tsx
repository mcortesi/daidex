...
export interface WaitingApprovalScreenProps {
  operation: Operation;
  tradeable: Token;
  amount: string;
  fromAddress: Address;
...
const WaitingApprovalScreen: React.SFC<WaitingApprovalScreenProps> = props => (
  <div className="widget-status">
    <h1 className="waiting">Waiting for Approval</h1>
    <dl>
...
export { WaitingApprovalScreen as Screen };
