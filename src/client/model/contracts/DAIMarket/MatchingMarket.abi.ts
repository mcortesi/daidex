const abi = [
  ...
  {
    constant: true,
    inputs: [{ name: 'sell_gem', type: 'address' }, { name: 'buy_gem', type: 'address' }],
    name: 'getBestOffer',
  ...
  {
    constant: false,
    inputs: [{ name: 'baseToken', type: 'address' }, { name: 'quoteToken', type: 'address' }],
  ...
  {
    constant: false,
    inputs: [{ name: 'id', type: 'uint256' }, { name: 'pos', type: 'uint256' }],
    name: 'insert',
    outputs: [{ name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ name: 'pay_gem', type: 'address' }, { name: 'dust', type: 'uint256' }],
    name: 'setMinSell',
    outputs: [{ name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'nonpayable',
